...
const SettingsModalHeader = ({ isElevated, closeSettingsModal }: SettingsModalHeaderProps) => {
  return (
    <div
    ...
    >
      ...
      <SettingsButton className="size-10" onClick={closeSettingsModal} aria-label="Close settings">
        X
      </SettingsButton>
    </div>
  )
